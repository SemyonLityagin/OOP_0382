...
Drawing::Drawing(Cell** cells) {
    ...
    textureButton[4].loadFromFile(SavePNG);
    textureButton[5].loadFromFile(Save1PNG);
    textureButton[6].loadFromFile(LoadPNG);
    textureButton[7].loadFromFile(Load1PNG);
}

void Drawing::DrawFieldOnWindow(RenderWindow *window) {
    //control buttons
    ...
    //save/load buttons
    sprite = Sprite(textureButton[4]);
    sprite.setPosition(Size*40, Size*40-80);
    window->draw(sprite);
    sprite = Sprite(textureButton[5]);
    sprite.setPosition(Size*40, Size*40-120);
    window->draw(sprite);
    sprite = Sprite(textureButton[6]);
    sprite.setPosition(Size*40+80, Size*40-80);
    window->draw(sprite);
    sprite = Sprite(textureButton[7]);
    sprite.setPosition(Size*40+80, Size*40-120);
    window->draw(sprite);
...
void Drawing::UpdateCells(Cell **cells) {
    this->cells = cells;
}
