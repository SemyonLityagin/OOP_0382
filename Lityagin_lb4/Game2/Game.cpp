...
Game<R1>::Game(R1 rule1) {
    ruleBuilder = rule1;
}

//template<RulesBuilder R1>
template<typename R1>
void Game<R1>::StartGame(int EVIL, int THING) {
    //Music background;
...
//template <RulesBuilder R1>
template<typename R1>
Unit** Game<R1>::CreateEvil(Cell** cell, int EVIL) {
...
//template <RulesBuilder R1>
template<typename R1>
Thing** Game<R1>::CreateThing(Cell** cell, int THING) {
